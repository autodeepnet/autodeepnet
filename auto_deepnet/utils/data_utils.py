...
inputs:
    ...
    - pandas_format: whether the pickled data is a pandas dataFrame
description:
...
'''
def save_hdf5_data(file_path, dataFrame, mode='a', key=None, append=False, pandas_format=True, **kwargs):
